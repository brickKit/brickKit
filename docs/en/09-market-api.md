...
- [Signing and the trust model](06-architecture/06-signing-and-trust.md) — why the market stores signatures but never verifies them
- [Self-hosting the BrickKit Market](07-patterns/09-deployment/self-hosted-market.md) — deploying the market itself
- [CLI command reference](06-architecture/09-cli-reference.md) — how `login`/`publish`/`add` use this API under the hood
