...
| 03 | [Hands-on guide](03-guide/README.md) | Walk it through yourself: dependencies, upgrades, Kubernetes, component source, the marketplace, signing, network policy… | You want to learn it systematically |
