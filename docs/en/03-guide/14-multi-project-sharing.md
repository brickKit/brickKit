...
Next: [Deploy with Podman instead of Docker](15-podman.md) — the same declaration, redeployed against a real Podman engine instead, including the one real gotcha that made this article possible at all.
