...
Next: [How the platform decides what runs](02-what-runs.md) — the same project, grown to several components with real dependencies between them, and what `mode` actually does when you start turning pieces off.
