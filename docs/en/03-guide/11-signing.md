...
Next: [Build your first component from scratch](12-build-your-own.md) — building a component from nothing, start to finish, the perspective every other article in this series has been the consuming side of.
