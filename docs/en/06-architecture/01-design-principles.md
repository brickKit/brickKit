...
**Example:** two versions side by side need only one entry each in `brickkit.yaml` (the full walkthrough is in [guide 6](../03-guide/06-upgrades-and-versions.md)):
...
**Example:** an artifact declaration (from `demo/hello`; see [guide 8](../03-guide/08-consuming-artifacts.md)):
...
- **What BrickKit does:**
  ...
  - See [network policy and least privilege](../03-guide/13-network-policy.md).
- **What BrickKit doesn't do:**
...
- **How an AI copes:**
  ...
  - See [build your first component](../03-guide/12-build-your-own.md).
