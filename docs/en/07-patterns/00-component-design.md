...
([testing](01-testing.md), [data construction](02-data-construction.md)):
...
| Published language / open host service | the contract files under `artifacts` | [Consuming other components](../03-guide/08-consuming-artifacts.md) |
