...
> Prerequisite: read [Architecture overview](../06-architecture/00-overview.md) first
...
> you how to build a shell (that's [Building a Qualified Shell](07-shell-implementers-guide.md))
...
- The shell author is entirely on their own for reconstructing what a real
  ...
  look like — [Building a Qualified Shell](07-shell-implementers-guide.md) has
...
versions, mixed deployment shapes"](07-shell-implementers-guide.md#multiple-versions-mixed-deployment-shapes)
...
- Some components will be shell-merged: read
  ...
  [Building a Qualified Shell](07-shell-implementers-guide.md) if you're the
  one building that shell.
- Targeting K8s: [`brickkit up --context <cluster>`](../06-architecture/09-cli-reference.md#brickkit-up),
  and [Real generated Docker Compose and Kubernetes files, side by side](../06-architecture/03-deployment-generation.md)
