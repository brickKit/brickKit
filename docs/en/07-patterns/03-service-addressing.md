...
- [04-environment-variables.md](../06-architecture/04-environment-variables.md) — exactly how a dependency's address lands in your environment as `{PREFIX}_ENDPOINT` in the first place
- [08-shared-connection-pools.md](08-shared-connection-pools.md) — the connection-pooling questions that come up once several components share one process inside a `servedBy` shell, a different problem from this document's single-component-calling-another-component case
