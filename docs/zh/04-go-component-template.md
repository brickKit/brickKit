...
- [组件设计准则](07-patterns/00-component-design.md) —— 动手写之前先做的领域研究
- [分层测试](07-patterns/01-testing.md) —— `component_test.go`/`migrate_test.go` 对应哪几层
- [部署文件生成](06-architecture/03-deployment-generation.md) —— `component.yaml` 怎么变成上面看到的那份 compose 文件
- [核心概念](01-concepts.md) —— 服务名、环境变量注入这些贯穿全平台的规则
