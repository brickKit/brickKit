...
改完想让别人（或者你自己的别的项目）用上这个改动，就是发布一个新版本的事了：改 `component.yaml` 里的版本号、构建新镜像、`brickkit publish`（[第 8 篇](08-marketplace.md)）；已经在用旧版本的项目怎么升级，是[第 5 篇](05-upgrades-and-versions.md)讲的。
