...
- 想理解刚才发生了什么？→ [核心概念](concepts.md)
- 想跟着更完整的教程动手做？→ [教程系列](guide/README.md)（这个 Quick Start 走的就是 [第一篇](guide/01-first-project.md) 的核心路径，教程里还讲了依赖、配置修改、K8s 部署等更多内容）
- 遇到问题了？→ [故障排除](troubleshooting.md)
