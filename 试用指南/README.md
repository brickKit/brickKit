...
| 06 | [06-K8s部署.md](06-K8s部署.md) | minikube 上的完整部署、迁移 Job、Ingress | 05 |
| 07 | [07-本地调试.md](07-本地调试.md) | `local: true`、`local-debug.env`、双向打通 | 05 |
| 08 | [08-升级与多版本.md](08-升级与多版本.md) | 改版本号即升级、兼容性检查、多版本共存 | 05 |
| 09 | [09-多副本与优雅排空.md](09-多副本与优雅排空.md) | 一个组件跑几份，以及**运维换机器时不会把你的服务一次干掉** | 07 |
| 10 | [10-组件市场.md](10-组件市场.md) | 起市场后端、`login`、`publish`、从市场安装 | 01 |
| 11 | [11-组件签名.md](11-组件签名.md) | **cosign 签名发布、验签安装、篡改后被拦住、digest 钉住** | 09 |
| 12 | [12-市场进阶.md](12-市场进阶.md) | 发出去之后：**谁能看见、谁能装、谁改过什么**（可见性 / 组织 / 访问策略 / 审计） | 09 |
| 13 | [13-完整装配.md](13-完整装配.md) | **八个组件一次装起来**：递归依赖、资源绑定、密钥、config 覆盖 | 05 |
| 14 | [14-依赖组合实验.md](14-依赖组合实验.md) | **亲手弄坏它**：强依赖 / 弱依赖 / 缓存 / 数据源四种故障表现 | 12 |
| 15 | [15-查看组件文档.md](15-查看组件文档.md) | 产物契约、文档中心、gRPC Reflection —— 怎么调别人的组件 | 12 |
| 16 | [16-K8s完整装配.md](16-K8s完整装配.md) | 同一套八个组件搬到 Kubernetes：Ingress、迁移 Job、`${VAR}` 求值 | 12 + minikube |
| 17 | [17-开发自己的组件.md](17-开发自己的组件.md) | **从零写一个组件**：四条硬约束、装进项目、本地调试、发布 | 01 |
| 18 | [18-网络策略与最小权限.md](18-网络策略与最小权限.md) | 依赖声明变成网络边界：入站、**出站**、拿掉 API 令牌 | 15 + 能执行策略的 CNI |
