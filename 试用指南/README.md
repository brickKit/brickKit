...
| 10 | [10-组件市场.md](10-组件市场.md) | 起市场后端、`login`、`publish`、从市场安装 | Docker |
...
| 13 | [13-完整装配.md](13-完整装配.md) | **八个组件一次装起来**：递归依赖、资源绑定、密钥、config 覆盖 | Docker |
...
| 17 | [17-开发自己的组件.md](17-开发自己的组件.md) | **从零写一个组件**：四条硬约束、装进项目、本地调试、发布 | Docker（发布那段需要 10） |
