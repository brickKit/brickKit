...
# 查看日志
docker compose -f .brickkit/generated/docker-compose.yaml logs hello-world-1-0-0
```
...
# 6. 查看日志
docker compose -f .brickkit/generated/docker-compose.yaml logs -f hello-world-1-0-1
```
...
```bash
# Docker 环境
docker compose -f .brickkit/generated/docker-compose.yaml logs people-basic-1-0-0-migration
