...
const (
	...
	CliStatusResourceStatus                = "cli.status.resource_status"
	CliStatusReachable                     = "cli.status.reachable"
	...
	CliStatusUnreachable                   = "cli.status.unreachable"
	...
	CliStatusInClusterAddressNotProbed     = "cli.status.in_cluster_address_not_probed"
	...
	CliStatusResourcesAreReachedInsideThe  = "cli.status.resources_are_reached_inside_the"
